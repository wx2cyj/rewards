...
export declare enum ExclusiveLockedFeature {
    Locked = "locked",
    Notsupported = "notsupported",
    Unlocked = "unlocked"
}
export declare enum GiveEligible {
    False = "False",
    True = "True"
}
...
export declare enum LegalLinkText {
...
export interface BasePromotion<TAttributes = Record<string, any>, TTitleStyle = string, TDescriptionStyle = string, TLegalLinkText = string, TExclusiveLockedFeatureCategory = ExclusiveLockedFeature, TPromotionType = string> {
    name: string;
    priority: number;
...
export type PromotionalItem = BasePromotion<DailySetPromotionAttributes, string, string, string, ExclusiveLockedFeature, Type>;
...
export type HighValueSweepstakesPromotion = BasePromotion<{
    [key: string]: string;
}>;
